...
results_high, total_cnrg_selections_high = test_multiple_lag_hold(returns, lag_values, hold_values, top_n=20, strategy_type='high')

# Test for 'low' strategy
results_low, total_cnrg_selections_low = test_multiple_lag_hold(returns, lag_values, hold_values, top_n=20, strategy_type='low')

# Test for 'high_minus_low' strategy
results_high_minus_low, total_cnrg_selections_high_minus_low = test_multiple_lag_hold(returns, lag_values, hold_values, top_n=20, strategy_type='high_minus_low')
